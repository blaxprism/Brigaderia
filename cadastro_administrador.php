...
<body>
	<main>
		...
		<section>
			...
			?>
			<br><br>
			<a href="cadastro_administrador.html" style="border-style: solid; border-color: #ffffff; background-color: #ffffff; color: #000000;">Retorne para a página de cadastro</a>
		</section>                
	</main>
</body>
</html>